...
print("进度条线:", to_units(find(barline, (0, 1400, 540, 590))))
print("星芒:", to_units(find(sparkle, (0, 300, 520, 610))))
print("Tips:", to_units(find(tips, (300, 1000, 580, 640))))
print("60%:", to_units(find(pct, (1100, 1400, 560, 640))))
